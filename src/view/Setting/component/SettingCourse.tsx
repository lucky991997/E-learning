...
const SettingCourse = ({ setShowComponent }: IShowComponent) => {
    ...
    return (
        <div className="setting-class">
            <div className="config__title mb-32" onClick={() => setShowComponent(true)}>
                ...
                <h1 className="main-title">Thiết lập môn học</h1>
            </div>
            ...
            {isModaldelete === true ?
                (
                    <ModalForm isModalVisible={isModaldelete} setIsModalVisible={setIsModalDelete}>
                        <FormDeleteSchoolYear setIsModalDelete={setIsModalDelete} title="Xóa môn học" />
                    </ModalForm>
                ) : ''
            }
        </div>
